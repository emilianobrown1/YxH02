...
BEAST_INFO = {
    ...
    "Voltaryn": {
        ...
        "Image": "Beast/Voltaryn.jpg"
    },
    "Cerberus": {
        "Name Meaning": "Cerberus = Mythical Guardian of the Underworld",
        "Role": "Treasure Guardian",
        "Lore": "A fearsome three-headed beast, standing as the eternal guardian of hidden treasures and lost relics.",
        "Powers": ["Flame Heat Inferno", "Darkness Shadow"],
        "Weakness": "None specified",
        "Image": "Beast/Cerberus.jpg"
    },
    "Vilescale": {
        "Name Meaning": "Vile = Corrupt, Scale = Serpent",
        "Role": "Collection Attacker",
        "Lore": "A venomous terror lurking in the shadows, Vilescale strikes swiftly and without mercy.",
        "Powers": ["Venom", "Natural Ground"],
        "Weakness": "Lightning, Darkness Shadow",
        "Image": "Beast/Vilescale.jpg"
    },
    "Frostclaw": {
        "Name Meaning": "Frost = Ice, Claw = Predator",
        "Role": "Crystal Attacker",
        "Lore": "Born in the frozen tundras, Frostclaw dominates the battlefield with icy precision.",
        "Powers": ["Strength", "Frost Snow"],
        "Weakness": "Speed, Thunder Storm, Darkness Shadow",
        "Image": "Beast/Frostclaw.jpg"
    },
    "Phoenix": {
        "Name Meaning": "Phoenix = Immortal Firebird",
        "Role": "Treasury Attacker",
        "Lore": "A legendary firebird reborn from its own ashes, leaving a trail of destruction in its wake.",
        "Powers": ["Darkness Shadow", "Flame Heat Inferno"],
        "Weakness": "Speed, Natural Ground",
        "Image": "Beast/Phoenix.jpg"
    },
    "Glacelynx": {
        "Name Meaning": "Glace = Ice, Lynx = Agile Hunter",
        "Role": "Crystal Guardian",
        "Lore": "A swift and cunning guardian of the frozen crystals, defending them against all who dare approach.",
    ...
    "Ignirax": {
        ...
        "Lore": "Ignirax, the Molten Annihilator, is the ultimate force of destruction, forged from the heart of an eternal volcanic storm.",
